...
/** Legacy `Remarks` table: 11 flat side columns keyed by container Name. */
@Entity(tableName = "Remarks", indices = [Index(value = ["Name"], unique = true)])
data class RemarksEntity(
